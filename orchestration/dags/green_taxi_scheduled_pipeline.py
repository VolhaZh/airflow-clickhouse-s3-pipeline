...
Runs on the 1st day of the month in 2020
"""
...
with DAG(
    ...
    def build_context() -> dict:
        ...
        if logical_date.year != 2020:
            raise ValueError("minio_taxi_scheduled supports only 2020 runs.")
    ...
    def create_clickhouse_tables(meta: dict, minio_key: str) -> None:
        ...
        create_final_sql = f"""
        CREATE TABLE IF NOT EXISTS {dataset}.green_tripdata_2020_all (
            VendorID String,
            lpep_pickup_datetime DateTime64,
            lpep_dropoff_datetime DateTime64,
            store_and_fwd_flag String,
        ...
        ENGINE = MergeTree
        ORDER BY (lpep_pickup_datetime, lpep_dropoff_datetime)
        """

        insert_sql = f"""
        INSERT INTO {dataset}.green_tripdata_2020_all (
            VendorID,
