...
with DAG(
    ...
    def build_context() -> dict:
        ...
        if logical_date.year != 2020:
            raise ValueError("yellow_taxi_scheduled supports only 2020 runs.")
    ...
    def create_clickhouse_tables(meta: dict, minio_key: str) -> None:
        ...
        create_final_sql = f"""
        CREATE TABLE IF NOT EXISTS {dataset}.yellow_tripdata_2020_all (
            VendorID String,
            tpep_pickup_datetime DateTime64,
            tpep_dropoff_datetime DateTime64,
            passenger_count UInt8,
        ...
        insert_sql = f"""
        INSERT INTO {dataset}.yellow_tripdata_2020_all (
            VendorID,
